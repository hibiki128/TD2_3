...
void Object3dCommon::Initialize() {
    ...
    computeSkinningRootSignature = psoManager_->CreateComputeSkinningRootSignature(computeSkinningRootSignature);
    computeSkinningGraphicsPipelineState = psoManager_->CreateComputeSkinningGraphicsPipeLine(computeSkinningGraphicsPipelineState, computeSkinningRootSignature);
}
...
void Object3dCommon::computeSkinningDrawCommonSetting() {
    psoManager_->DrawComputeSetting(computeSkinningGraphicsPipelineState, computeSkinningRootSignature);
}
