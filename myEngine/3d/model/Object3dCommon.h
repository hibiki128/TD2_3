...
class Object3dCommon {
  ...
  private:
    ...
    // ルートシグネチャ
    Microsoft::WRL::ComPtr<ID3D12RootSignature> computeSkinningRootSignature = nullptr;

    // グラフィックスパイプライン
    Microsoft::WRL::ComPtr<ID3D12PipelineState> computeSkinningGraphicsPipelineState = nullptr;
